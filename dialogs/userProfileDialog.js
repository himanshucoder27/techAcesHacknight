...
class UserProfileDialog extends ComponentDialog {
    ...
    async nameStep(step) {
        ...
        return await step.prompt(NAME_PROMPT, 'Hi, my name is Mysurance, What is your name?');
    }
    ...
    async nameConfirmStep(step) {
        ...
        const promptOptions = { prompt: 'Please enter your email Id', retryPrompt: 'The value entered must be valid Email.' };
    ...
    async mobileStep(step) {
        step.values.mobileNo = step.result;
    ...
    async summaryStep(step) {
        if (step.result) {
            ...
            userProfile.mobileNo = step.values.mobileNo;
            

            let msg = `I have your name as ${ userProfile.name }`;
            msg += ` and your mobile number as ${userProfile.mobileNo}`;
